...
uses SysUtils;
                ...
                Type TFileBuffer = Array of Byte;
...
if fileexists(filename) then
        ...
        {$I-}
        Reset(F,1 );
        SetLength(Filebuffer, GetFileSize);

        for i:=0 to High(FileBuffer) do
                begin
                BlockRead(F, FileBuffer[I], 1);
                end;
...
function TCRC32.GetFileSize: Integer;
begin
Result:=FileSize(F);
end;
